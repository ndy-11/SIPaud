...
<body>
	...
	<section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?= base_url() ?>assets/template/adminwrap/assets/images/background/login-register.jpg);">
		<div class="login-box card">
			<div class="card-body">
				<form method="POST" action="<?php echo base_url().'log_walimurid/aksi' ?>">
					<input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>" />
					<a href="<?= base_url() ?>" class="text-center db">
						<img src="<?= base_url('assets\template\adminwrap\assets\images\logo_paud.png') ?>" alt="Home" width="180" />
					</a>
					<h3 class="text-center">PAUD FLAMBOYAN</h3>
					<hr>
