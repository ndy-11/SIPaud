...
<head>
	...
	<!-- Chart CSS -->
	<link href="<?= base_url() ?>assets/template/adminwrap/assets/node_modules/chartjs/Chart.js" rel="stylesheet">
	<!-- Datatables -->
...
<body class="card-no-border">
	<!-- Memanggil file php di orangtua/components/preloadder.php -->
	<div id="main-wrapper">
		<!-- Memanggil file php di orangtua/components/header.php -->
		<?php $this->load->view('orangtua/components/header') ?>
		<!-- Memanggil file php di orangtua/components/sidebar.php -->
		<?php $this->load->view('orangtua/components/sidebar') ?>
		<!-- Content -->
		<div class="page-wrapper">
			<!-- Memanggil varible viewUtama dari method controller -->
			<?php $this->load->view($viewUtama) ?>
			<!-- Memanggil file php di orangtua/components/footer.php -->
			<?php $this->load->view('orangtua/components/footer') ?>
		</div>
	</div>
