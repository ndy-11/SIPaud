...
<body class="fix-header card-no-border fix-sidebar">
	...
	<?php $this->load->view('kepsek/components/preloadder') ?>
	<div id="main-wrapper">
		<!-- Memanggil file php di admin/components/header.php -->
		<?php $this->load->view('kepsek/components/header') ?>
		<!-- Memanggil file php di admin/components/sidebar.php -->
		<?php $this->load->view('kepsek/components/sidebar') ?>
		<!-- Content -->
		<div class="page-wrapper">
			...
			<?php $this->load->view('kepsek/components/footer') ?>
		</div>
	</div>
