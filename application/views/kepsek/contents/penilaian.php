<div class="container-fluid">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor">Penilaian</h3>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?= base_url('guru') ?>">Guru</a></li>
				<li class="breadcrumb-item active">Kelola Penilaian</li>
			</ol>
		</div>
	...
	<div class="row">
		<div class="col-12">
			...
			<div class="card ribbon-wrapper">
				<div class="ribbon ribbon-bookmark ribbon-default">Data Penilaian</div>
				<div class="card-body">
								...
								foreach ($pengajaranS as $pengajaran) : ?>
									<tr>
										...
										<td style="text-align:center">
											<a href="<?= base_url('guru/nilai/' . $pengajaran['id_pengajaran']) ?>" class="btn btn-secondary btn-sm"><i class="icon-File-Search"></i> Input Nilai</a>
