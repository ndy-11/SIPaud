<div class="container-fluid">
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			...
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?= base_url('orangtua') ?>">Guru</a></li>
					...
					<div class="row">
						<div class="col-12 col-lg-12">
							<a href="<?php echo base_url().'guru/balas_chatting'; ?>"><button class="btn btn-info" style="margin-left: 30px;"><i class="fa fa-plus"></i> Mulai Chat</button></a>
							 <a href="<?php echo base_url().'guru/out_chatting'; ?>"><button class="btn btn-warning" style="margin-left: 30px;"><i class="fa fa-plus"></i> History Pesan Keluar</button></a> 
							<hr>
										...
										<?php else : ?>
											...
											foreach ($chatting as $c) : ?>
												<tr>
													...
													<td><?= $c['subjek'] ?></td>
													<td><?= $c['isi_pesan'] ?></td>
													<td><a href="<?php echo base_url().'guru/balas_chatting/'.$c['id']; ?>"><button class="btn btn-success" style="margin-left: 30px;"><i class="fa fa-comment"></i> Balas Pesan</button></a></td>
												</tr>
											<?php endforeach ?>
										<?php endif ?>
									</tbody>
